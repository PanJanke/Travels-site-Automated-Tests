...
public class HotelSearch {
    ...
    public void searchHotel(){
        ...
        //driver.findElement(By.name("checkout")).sendKeys("1/04/2023");
        driver.findElement(By.name("checkout")).click();
        //driver.findElement(By.xpath("//td[@class='day ' and text()='30']")).click(); // ty akurat dziala to rozwiazanie ale moze sie wyswietlac wiecej 30-tek w kalendarz, zalezy do miesiaca
